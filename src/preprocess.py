...
from config import datasets, data_folder, processed_folder
...
def load_and_save(category, filename, dataset, dataset_folder):
    ...
    np.save(os.path.join(processed_folder, f"SMD/{dataset}_{category}.npy"), temp)
    return temp.shape
...
def load_data(dataset):
	if dataset in datasets:
		folder = os.path.join(processed_folder, dataset)
...
if __name__ == '__main__':
    ...
    print(input_datasets, data_folder, processed_folder)
